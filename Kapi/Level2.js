document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateTree() {
      const treeImages = [
        'Level2images/summertree1.png',
        'Level2images/summertree2.png',
        'Level2images/summertree3.png',
        'Level2images/summertree4.png',
        'Level2images/summertree5.png',
        'Level2images/summertree6.png'
      ];
