document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateTree() {
      const treeImages = [
        'Level3images/autumntree1.png',
        'Level3images/autumntree2.png',
        'Level3images/autumntree3.png',
        'Level3images/autumntree4.png',
        'Level3images/autumntree5.png',
      ...
      tree.style.top = gameContainer.clientHeight - ground.clientHeight - 80 + 'px';
